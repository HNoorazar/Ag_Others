...
print("Number of fields in 2018 shapefile is ", SF.size());
...
var big_rectangles_featC = ee.FeatureCollection(WA);
var reduction_geometry = ee.FeatureCollection(SF);

print ("Number of fields in the shapefile is", big_rectangles_featC.size());
...
//   var start_date = ee.String('2018-').cat(m).cat('-01');
//   var end_date = ee.String('2018-').cat(m).cat('-').cat(ed);
//   var imageC = extract_sentinel_IC(big_rectangles_featC, start_date, end_date);
...
var imageC = extract_sentinel_IC(big_rectangles_featC, wstart_date, wend_date);
print(imageC.size());
...
// var outfile_name = 'Eastern_WA_2018_' + cloud_perc + "cloud";
// Export.table.toDrive({
