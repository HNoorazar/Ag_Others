...
#SBATCH --requeue
#SBATCH --job-name=00_NL_outer # Job Name
...
###SBATCH -k o
#SBATCH --output=/home/h.noorazar/Sid/sidFabio/00_cumGDD_separateLocationsModels/error/nonLinear_cumGDD_outer.o
#SBATCH --error=/home/h.noorazar/Sid/sidFabio/00_cumGDD_separateLocationsModels/error/nonLinear_cumGDD_outer.e
...
Rscript --vanilla /home/h.noorazar/Sid/sidFabio/00_cumGDD_separateLocationsModels/d_cumGDD_nonLinear.R veg_type modelName param_type
