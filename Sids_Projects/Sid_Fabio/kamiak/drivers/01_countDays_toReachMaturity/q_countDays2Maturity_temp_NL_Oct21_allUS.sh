...
#SBATCH --requeue
#SBATCH --job-name=01_NL_US_outer # Job Name
...
###SBATCH -k o
#SBATCH --output=/home/h.noorazar/Sid/sidFabio/01_countDays_toReachMaturity/error/matureEE_NL_Oct_21_allUS_outer.o
#SBATCH  --error=/home/h.noorazar/Sid/sidFabio/01_countDays_toReachMaturity/error/matureEE_NL_Oct_21_allUS_outer.e
echo
...
module load r/4.1.0
Rscript --vanilla /home/h.noorazar/Sid/sidFabio/01_countDays_toReachMaturity/d_countDays_to_maturity_NL_Oct21_allUS.R veg_type model_type start_doy param_type
