...
#SBATCH --requeue
#SBATCH --job-name=sBs_outer # Job Name
...
###SBATCH -k o
#SBATCH --output=/home/h.noorazar/Sid/sidFabio/01_countDays_toReachMaturity/error/01_sBs_outer.o
#SBATCH  --error=/home/h.noorazar/Sid/sidFabio/01_countDays_toReachMaturity/error/01_sBs_outer.e
echo
