...
data_dir <- paste0(dir_base, veg_type, "_special_order/") # , gsub("-", "", model_type), "/"
...
current_out = paste0(out_dir_base, "/02_aggregate_Maturiry_EE/", veg_type, "_special_order/") # "_", model_type, 
