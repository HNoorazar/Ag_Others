...
\end{deff}
\iffalse
The above definition is from the book and it's considering the dependent variable into account.
But what if there is no dependent variable? Then we have the following:
\fi
